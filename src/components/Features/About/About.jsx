      ...
      ></div>
        ...
        <div className="relative max-w-7xl mx-auto px-6 sm:px-6 lg:px-8 text-start">
          ...
          <div className="flex flex-wrap justify-start gap-4">
            <button aria-label="our story" className="group inline-flex items-center justify-center gap-2.5 py-3 px-6 rounded-full text-[16px] font-semibold no-underline transition-all duration-300 cursor-pointer max-md:w-full bg-linear-to-br from-[#FF7203] to-[#FF9A03] text-white shadow-[0_10px_30px_rgba(255,165,0,0.3)] hover:-translate-y-0.75 hover:shadow-[0_15px_40px_rgba(255,165,0,0.4)]">
              Our Story
            </button>
            <button aria-label="meeet team" className="px-8 py-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-bold rounded-full transition-all duration-300 border border-white/20">
              Meet the Team
            </button>
          </div>
        </div>
      ...
      <section className="py-24 bg-linear-to-br  from-orange-400 via-orange-500 to-red-500 shadow-2xl text-white relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button aria-label="Shop" className="px-8 py-4 bg-orange-800 hover:bg-orange-600 text-white font-bold rounded-full transition-all duration-300 hover:-translate-y-1 hover:shadow-lg hover:shadow-orange-500/30">
              Shop Now
            </button>
            <button aria-label="contact" className="px-8 py-4 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-bold rounded-full transition-all duration-300 border border-white/20">
              Contact Us
            </button>
          </div>
        </div>
