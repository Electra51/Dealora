...
//       .then((res) => res.json())
//       .then((data) => {
//         // ✅ Fixed: Filter by newArrival flag, then sort by rating
//         const latest = data
//           .filter((p) => p.newArrival) // Only new arrivals
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="flex items-end justify-between gap-3 pt-4 border-t border-gray-100">
                ...
                <button
                  onClick={() => handleAddToCart(product)}
                  className="w-11 h-11 rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 flex items-center justify-center shrink-0 hover:scale-110 hover:shadow-lg hover:shadow-blue-500/40 transition-all duration-300"
                >
                  <svg
                    className="w-5 h-5 text-white"
                    fill="none"
