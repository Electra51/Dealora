    ...
    >
      ...
      <div className={`relative bg-linear-to-br from-gray-50 to-gray-100 ${
        ...
        <div className="absolute top-2 left-2 md:top-3 md:left-3 flex flex-col gap-1.5 md:gap-2 z-10">
          {discount > 0 && (
            <span className="bg-linear-to-r from-orange-400 to-amber-400 text-white text-[10px] md:text-[11px] font-bold px-2 py-0.5 md:px-2.5 md:py-1 rounded-full shadow-sm">
              {discount}% Off
            </span>
          )}
